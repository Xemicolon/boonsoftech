  ...
  <div class="carousel relative shadow-2xl bg-white">
    <div class="carousel-inner relative overflow-hidden w-full">
      ...
      <input
        ...
        checked="checked"
      />
      <div class="carousel-item absolute opacity-0 lg:h-screen sm-screen">
        <div
          class="slide1 block h-full w-full bg-indigo-800 text-white text-5xl text-center"
          style="display: flex;
    align-items: center;
    justify-content: center;"
        >
          <span class="z-10 build">
            BUILD
            <span class="text-blue-600">IT</span>
          </span>
        </div>
        <div
          class="absolute inset-0 bg-black opacity-50 h-full flex flex-col z-15 text-white"
        ></div>
      </div>
      <label
        for="carousel-3"
      ...
      <div class="carousel-item absolute opacity-0 lg:h-screen sm-screen">
        <div
          class="slide2 block h-full w-full bg-indigo-800 text-white text-5xl text-center"
          style="display: flex;
    align-items: center;
    justify-content: center;"
        >
      ...
      <div class="carousel-item absolute opacity-0 lg:h-screen sm-screen">
        <div
          class="slide3 block h-full w-full bg-indigo-800 text-white text-5xl text-center"
          style="display: flex;
    align-items: center;
    justify-content: center;"
        >
    ...
    <div class="bg-gray-800 py-12 lg:pl-40 pl-8">
      <h3 class="text-white text-left text-xl">
        We are
        <em style="font-family: 'Shadows Into Light', cursive;" class="text-3xl"
          >BOONSOFTECH</em
        >
        <br />
        <span class="text-md">...we are here for you!</span>
      </h3>
    </div>
  </div>
</template>
...
.slide1 {
  background-image: url("https://res.cloudinary.com/tobilite/image/upload/v1590529139/oreoluwa/slide11.jpg");
...
.slide2 {
  background-image: url("https://res.cloudinary.com/tobilite/image/upload/v1590531900/oreoluwa/slide2.png");
  background-size: cover;
  background-attachment: scroll;
  background-position: center;
}
...
.slide3 {
  background-image: url("https://res.cloudinary.com/tobilite/image/upload/v1590533638/oreoluwa/slide3.jpg");
  background-size: cover;
  background-attachment: scroll;
  background-position: center;
}
